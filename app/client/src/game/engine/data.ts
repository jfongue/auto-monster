...
export const SPECIES: Record<string, SpeciesDef> = {
  ...
  snailorn: { id: "snailorn", name: "Snailorn", kind: "automonster", rarity: "common", gfx: "snailorn", size: 100, baseStats: st(50, 11, 17, 18), innate: null, talentPool: [], tint: "#a99484", desc: "Escargot des chemins, coquille rayée comme une corne d'abondance.", wildEncounterable: false },
  axolotine: { id: "axolotine", name: "Axolotine", kind: "automonster", rarity: "rare", gfx: "axolotine", size: 100, baseStats: st(64, 17, 12, 36), innate: null, talentPool: [], tint: "#c28fae", desc: "Axolotl rose des rivières calmes, rare et d'une timidité désarmante.", wildEncounterable: false },
  ...
  bellwisp: { id: "bellwisp", name: "Bellwisp", kind: "automonster", rarity: "common", gfx: "bellwisp", size: 100, baseStats: st(46, 15, 8, 34), innate: null, talentPool: [], tint: "#7dbabc", desc: "Esprit-cloche translucide, flotte en laissant une traînée de bulles.", wildEncounterable: false },
  ...
  thicket: { id: "thicket", name: "Thicket", kind: "automonster", rarity: "common", gfx: "thicket", size: 100, baseStats: st(58, 13, 14, 22), innate: null, talentPool: [], tint: "#667439", desc: "Buisson ambulant aux bras noueux, dort debout au milieu des fougères.", wildEncounterable: false },
  ...
  bannertail: { id: "bannertail", name: "Bannertail", kind: "automonster", rarity: "rare", gfx: "bannertail", size: 100, baseStats: st(62, 20, 11, 52), innate: null, talentPool: [], tint: "#a2716a", desc: "Oiseau héraut à la queue en étendard, rare messager des grands vents.", wildEncounterable: false },
};
...
export const MAP_LOCATIONS: MapLocation[] = [
  ...
  // ── Vallée sauvage (combats) ───────────────────────────────────────────────
  {
    ...
    y: 620,
    icon: "⚔️",
    desc: "Une flammèche facétieuse danse sur une souche calcinée.",
    enemySpecies: "waxwick",
    enemyLevel: 1,
    isBoss: false,
    recommendedLevel: 1,
    gold: 20,
  ...
  },
  {
    ...
    y: 440,
    icon: "⚔️",
    desc: "Une boule de piquants pastel se hérisse dans les rafales.",
    enemySpecies: "spinepuff",
    enemyLevel: 2,
    isBoss: false,
    recommendedLevel: 2,
    gold: 25,
  ...
  },
  {
    ...
    y: 640,
    icon: "⚔️",
    desc: "Un insecte cuirassé guette, immobile, prêt à charger.",
    enemySpecies: "beetlorn",
    enemyLevel: 3,
    isBoss: false,
    recommendedLevel: 3,
    gold: 30,
  ...
  },
  {
    ...
    y: 400,
    icon: "⚔️",
    desc: "Un fragment de météore gravite en grondant à peine.",
    enemySpecies: "meteorb",
    enemyLevel: 4,
    isBoss: false,
    recommendedLevel: 4,
    gold: 40,
